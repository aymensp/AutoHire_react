  ...
  if (avg6 <= 1) {
    ...
    return (
      ...
      <div className="widgets__headerC">
          <h1 style={{color:'#eb0392'}}>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Ratings </h1>
          </div>

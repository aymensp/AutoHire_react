...
const ListEmp = forwardRef(({idC, nom, industry ,about }) => {
        ...
        ({username,email ,entreprise}) =>
                      {
                       ...
                       return  (
                        ...
                        <main><center>
        <button  style={{ color : 'white' , fontSize:'13px',lineHeight:'1.7',marginLeft:'115px' }} className="btn" onClick={()=> setButtonPopup(true)} > Ratings
